...
class TestMailCommand extends Command
{
    ...
    public function handle()
    {
        ...
        try {
            // Enviamos de forma síncrona (sin cola) para ver el error de red inmediatamente en la consola
            Mail::to($email)->send(new NotificationMail(
                "Prueba de Conexión SMTP - Sergestiona 2.0",
                "¡Éxito! El puerto 587 y las credenciales de Office 365 están funcionando correctamente desde el servidor de Sergestiona 2.0."
            ));
